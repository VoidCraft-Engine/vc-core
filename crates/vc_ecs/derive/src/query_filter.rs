...
use crate::world_query::world_query_impl;
...
pub fn derive_query_filter_impl(input: TokenStream) -> TokenStream {
    ...
    let filter_impl = quote! {
        ...
        unsafe impl #user_impl_generics #vc_ecs_path::query::QueryFilter
        for #struct_name #user_ty_generics #user_where_clauses {
            const IS_ARCHETYPAL: bool = true #(&& <#field_types as #vc_ecs_path::query::QueryFilter>::IS_ARCHETYPAL)*;
    ...
    TokenStream::from(quote! {
        ...
        const _: () = {
            ...
            fn assert_filter<T>()
            where
                T: #vc_ecs_path::query::QueryFilter,
            {
            }
