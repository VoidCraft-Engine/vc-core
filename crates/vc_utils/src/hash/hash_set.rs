...
/// New-type for [`HashSet`](hb::HashSet) with [`FixedHashState`] as the default hashing provider.
...
impl<T, const N: usize> From<[T; N]> for HashSet<T, FixedHashState>
where
    T: Eq + Hash,
{
...
impl<T> HashSet<T, FixedHashState> {
